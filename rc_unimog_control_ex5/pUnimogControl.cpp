...
//
//----------------------------------------------------------------------
/*!\file    projects/rc_unimog_control_ex5/pUnimogControl.cpp
 *
 * \author  Tobias Groll
 *
 * \date    2017-03-31
...
#include "projects/rc_unimog_control_ex5/gMainControl.h"
...
void CreateMainGroup(const std::vector<std::string> &remaining_arguments)
{
  ...
  auto control = new finroc::rc_unimog_control_ex5::gMainControl(main_thread);
