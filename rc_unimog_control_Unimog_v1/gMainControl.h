...
public:
  ...
  tControllerOutput<bool> object_test;
  tControllerOutput<rrlib::distance_data::tDistanceData> closest_object;
  ...
  //tParameter<rrlib::si_units::tVelocity<>> velocity;
  //tParameter<rrlib::si_units::tCurvature<double>> steering_degree;
  //tControllerOutput<rrlib::si_units::tVelocity<>> velocityT;
  //tControllerOutput<rrlib::si_units::tCurvature<double>> curvatureT;
//----------------------------------------------------------------------
