...
//
//----------------------------------------------------------------------
/*!\file    projects/rc_unimog_control_zed2/mImageManipulator.h
 *
 * \author  Manuel Vogel
 *
 * \date    2020-11-24
 *
 * \brief Contains mImageManipulator
 *
 * \b mImageManipulator
 *
 * it takes an image from the camera and changes it
 *
 */
//----------------------------------------------------------------------
#ifndef __projects__rc_unimog_control_image_manipulator__mImageManipulator_h__
#define __projects__rc_unimog_control_image_manipulator__mImageManipulator_h__
 ...
 * it takes an image from the camera and changes it
 */
class mImageManipulator : public structure::tModule
{
...
public:
  ...
  mImageManipulator(core::tFrameworkElement *parent, const std::string &name = "ImageManipulator");
...
private:
  ...
  //rrlib::coviroa::tImage currentImage;
